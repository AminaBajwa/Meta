      ...
      <div>
        ...
        <p className="text-gray-200">In the dynamic field of education, we provide innovative solutions that enhance learning experiences and streamline administrative processes. Our services are designed to improve educational outcomes, foster collaboration, and manage resources efficiently.</p>
            <ul className="list-disc text-gray-200 space-y-2 pl-4 mt-6">
              ...
              <li>Virtual classrooms and e-learning platforms</li>
              <li>Administrative and financial management software</li>
            </ul>
      </div>
...
{/* feature2 */}
      <div className="max-md:order-3 my-20">
        ...
        <ul className="list-disc text-gray-200 space-y-2 pl-4 mt-6">
              ...
              <li>Medical billing and coding software</li>
            </ul>
      </div>
      <div>
...
{/* feature3 */}
      ...
      <div>
        <h3 className="md:text-4xl text-3xl font-semibold md:!leading-[50px] mb-6 text-white">Accounting and Finance</h3>
        ...
        <ul className="list-disc text-gray-200 space-y-2 pl-4 mt-6">
              ...
              <li>Accounting and auditing tools</li>
...
{/* feature5 */}
      ...
      <div>
        ...
        <ul className="list-disc text-gray-200 space-y-2 pl-4 mt-6">
              ...
              <li>Freight and cargo management solutions</li>
              <li>Real-time tracking and fleet management systems</li>
