            ...
            <ul className='lg:flex lg:gap-x-10 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-[550px] max-lg:shadow-md max-lg:overflow-auto z-50'>
              ...
              <li className="group max-lg:border-b max-lg:py-3 relative z-40">
                ...
                <ul className="absolute shadow-lg bg-white space-y-3 lg:top-5 max-lg:top-8 -left-6 min-w-[250px] z-50 max-h-0 overflow-hidden group-hover:opacity-100 group-hover:max-h-[700px] px-6 group-hover:pb-4 group-hover:pt-6 transition-all duration-500 mt-5 rounded-xl">
                  <li className="border-b py-2 "><a href="/WebDev" className="hover:text-[#9615DB] text-gray-600 text-[13px] font-bold block">Web Development</a></li>
                  <li className="border-b py-2 "><a href="/MobDev" className="hover:text-[#9615DB] text-gray-600 text-[13px] font-bold block">Mobile App Development</a></li>
                  <li className="border-b py-2 "><a href="/DekstopApp" className="hover:text-[#9615DB] text-gray-600 text-[13px] font-bold block">Desktop App Development </a></li>
                  <li className="border-b py-2 "><a href="/GenAiDev" className="hover:text-[#9615DB] text-gray-600 text-[13px] font-bold block">Generative AI Development </a></li>
                  <li className="border-b py-2 "><a href="/MSPower" className="hover:text-[#9615DB] text-gray-600 text-[13px] font-bold block">MS Power Platform </a></li>
                  <li className="border-b py-2 "><a href="/CRM" className="hover:text-[#9615DB] text-gray-600 text-[13px] font-bold block">Salesforce CRM</a></li>
                </ul>
              </li>
              ...
              <li className="group max-lg:border-b max-lg:py-3 relative z-30">
                ...
                <ul className="absolute shadow-lg bg-white space-y-3 lg:top-5 max-lg:top-8 -left-6 min-w-[250px] z-50 max-h-0 overflow-hidden group-hover:opacity-100 group-hover:max-h-[700px] px-6 group-hover:pb-4 group-hover:pt-6 transition-all duration-500 bg-white/3 mt-5 rounded-xl">
                  <li className="border-b py-2 "><a href="/Flutter" className="hover:text-[#9615DB] text-gray-600 text-[13px] font-bold block">Flutter</a></li>
                  <li className="border-b py-2 "><a href="/MERN" className="hover:text-[#9615DB] text-gray-600 text-[13px] font-bold block">MERN Stack</a></li>
                  <li className="border-b py-2 "><a href="/OracleApex" className="hover:text-[#9615DB] text-gray-600 text-[13px] font-bold block">Oracle Apex</a></li>
                  <li className="border-b py-2 "><a href="/DotNet" className="hover:text-[#9615DB] text-gray-600 text-[13px] font-bold block">.NET</a></li>
                  <li className="border-b py-2 "><a href="/ML" className="hover:text-[#9615DB] text-gray-600 text-[13px] font-bold block">Machine Learning</a></li>
                </ul>
              </li>
              ...
              <li className="max-lg:border-b max-lg:py-3"><a href="/Contact_us" className="hover:text-[#9615DB] text-[#030014] lg:text-white text-[13px] uppercase font-bold block">Contact</a></li>
            </ul>
          </div>
