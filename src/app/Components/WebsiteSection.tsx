...
const WebsiteSection = () => {
  ...
  <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl max-md:max-w-md mx-auto">
    <div className="max-md:text-center">
      <h3 className="md:text-3xl text-2xl md:leading-10">Web Development Project - Enhancing Digital Presence</h3>
