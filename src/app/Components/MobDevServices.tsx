...
<section className="relative py-10 overflow-hidden bg-black sm:py-16 lg:py-24 xl:py-32">
  ...
  <div className="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
    <div className="text-center md:w-2/3 lg:w-1/2 xl:w-1/3 md:text-left">
      ...
      <p className="mt-4 text-base text-gray-200">We specialize in crafting high-quality mobile applications using the cutting-edge technology. Whether you're a startup or an established enterprise, our team of skilled developers is dedicated to turning your ideas into innovative and seamless mobile experiences.</p>
